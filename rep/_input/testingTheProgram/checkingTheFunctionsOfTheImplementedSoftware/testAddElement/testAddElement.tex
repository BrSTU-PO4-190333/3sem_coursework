...
\begin{figure}[p]
    \center{
        \includegraphics[width=10.5cm]
        {../_input/tests/mysql_table_before.png}
    }
...
\begin{figure}[p]
    \center{
        \includegraphics[width=10.5cm]
        {../_input/tests/site_table_before.png}
    }
...
\begin{figure}[p]
    \center{
        \includegraphics[width=10.5cm]
        {../_input/tests/site_form_add_element_to_table.png}
    }
...
\begin{figure}[p]
    \center{
        \includegraphics[width=10.5cm]
        {../_input/tests/mysql_table_after.png}
    }
